# Danny's 40th ticket page template v4
...
```js
const API_URL = "https://script.google.com/macros/s/AKfycbxD13uXpcX1WJox2wZvDhPxG7qQu67MkuFY9f0AbrPrTXOzwwMjZuknVgaaBp6XtiiA7g/exec";
```
